...
class lti_edit_types_form_test extends \advanced_testcase {
    ...
    /**
     * Tests the nested course categories JSON returned by public method core_ltix_edit_types_form::lti_build_category_tree().
     *
     * @covers \core_ltix_edit_types_form::lti_build_category_tree
     */
