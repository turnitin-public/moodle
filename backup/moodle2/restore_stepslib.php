...
/**
 * Structure step to restore lit content
 */
class restore_lti_structure_step extends restore_structure_step {
    ...
    protected function define_structure() {
        ...
        $lti = new restore_path_element('lti', '/lti');
        $paths[] = $lti;
        $paths[] = new restore_path_element('ltitype', '/lti/ltitype');
        $paths[] = new restore_path_element('ltitypesconfig', '/lti/ltitype/ltitypesconfigs/ltitypesconfig');
        $paths[] = new restore_path_element('ltitypesconfigencrypted',
            '/lti/ltitype/ltitypesconfigs/ltitypesconfigencrypted');
        $paths[] = new restore_path_element('ltitoolproxy', '/lti/ltitype/ltitoolproxy');
        $paths[] = new restore_path_element('ltitoolsetting', '/lti/ltitype/ltitoolproxy/ltitoolsettings/ltitoolsetting');
        $paths[] = new restore_path_element('lticoursevisible', '/lti/lticoursevisible');

        // Add support for subplugin structures.
        /* Commenting this until ltisource is migrated fully to ltix.
     ...
     * @return void
     */
    public function process_lticoursevisible($data) {
        global $DB;
     ...
     */
    public function find_existing_lti_type($data) {
        global $DB;
